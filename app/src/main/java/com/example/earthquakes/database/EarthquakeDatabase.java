...
// Esta clase se va a usar como la base de datos de Room en Android
//Necesita ser asbtracta, la anotacion @Database y extender de RoomDatabase
        ...
        synchronized (EarthquakeDatabase.class) {
            if (INSTANCE == null) {
                INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            EarthquakeDatabase.class, "earthquakes_db")
                        .build();
            }
        }
